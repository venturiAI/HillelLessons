...
# CHATGPT только освежил знания уже несколько раз пройденного материала и дал примеры с реализацией divmod, остальное я соединил и реализовал. Процентов 70% моей заслуги, но навряд ли я такое смогу написать с нулю. Понимание есть, а реализацию нужно больше практиковать.
