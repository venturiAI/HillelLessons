...
# CHATGPT только освежил знания уже несколько раз пройденного материала (не лучшая память) и дал примеры с реализацией divmod, остальное сам додумал, сеоиднили и реализовал.
#Из того что я увидел и взял на заметку  1000  <= user_numbers <= 9999. Понравилось.
